...
const SECRET_KEY = "my_shared_secret"; // For demo only — generate per friend later
...
export default function Chat({ userEmail, friendEmail }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-black text-white p-4">
      ...
      <div className="max-w-xl mx-auto border border-white/20 rounded-xl p-4 bg-white/10 h-[500px] flex flex-col">
        <div className="flex-1 overflow-y-auto space-y-2">
          {messages.map((msg, i) => (
            <div key={i} className={`p-2 rounded-lg ${msg.sender === "You" ? "bg-blue-500 self-end" : "bg-gray-700 self-start"}`}>
